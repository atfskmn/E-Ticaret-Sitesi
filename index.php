	...
	<div class="container">
		<div class="row">
			<div class="col-md-9"><!--Main content-->
				...
				<div class="title-bg">
					<div class="title">Son Eserler</div>
				</div>
				<div class="row prdct"><!--Products-->
					<div class="col-md-4">
						<div class="productwrap">
							<div class="pr-img">
								<a href="product.htm"><img src="images\romanlar-1.jpg" alt="" class="img-responsive"></a>
								<div class="pricetag on-sale"><div class="inner on-sale"><span class="onsale"><span class="oldprice">$2300</span>$199</span></div></div>
							</div>
							<span class="smalltitle"><a href="product.htm">ürün bilgileri eklenecek</a></span>
					...
					<div class="col-md-4">
						<div class="productwrap">
							<div class="pr-img">
								<a href="product.htm"><img src="images\romanlar-2.jpg" alt="" class="img-responsive"></a>
					...
					<div class="col-md-4">
						<div class="productwrap">
							<div class="pr-img">
								<a href="product.htm"><img src="images\romanlar-4.jpg" alt="" class="img-responsive"></a>
								<div class="pricetag"><div class="inner">$199</div></div>
							</div>
							<span class="smalltitle"><a href="product.htm">ürün bilgileri eklenecek</a></span>
							<span class="smalldesc">Item no.: 1000</span>
					...
					<div class="col-md-4">
						<div class="productwrap">
							<div class="pr-img">
								<a href="product.htm"><img src="images\romanlar-3.jpg" alt="" class="img-responsive"></a>
								<div class="pricetag"><div class="inner">$199</div></div>
							</div>
							<span class="smalltitle"><a href="product.htm">ürün bilgileri eklenecek</a></span>
							<span class="smalldesc">Item no.: 1000</span>
